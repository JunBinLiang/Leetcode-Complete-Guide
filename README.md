...
|  323  |[Number of Connected Components in an Undirected Graph](./code/323.txt) | (M-) 1500  |
...
|  1085  |[Sum of Digits in the Minimum Number](./code/1085.txt)| (E) 800 ||  1087  |[Brace Expansion](./code/1087.txt)| (M) 1500 |
...
|  1199  |[Minimum Time to Build Blocks](./code/1199.txt)  | (H-) 1700 |
...
|  1257  |[Smallest Common Region (LCA)](./code/1257.txt) |(M) 1500  ||  1273  |[Delete Tree Nodes](./code/1273.txt) |(M) 1500  |
|  1259  |[Handshakes That Don't Cross ](./code/1259.txt) |(H-) 1700  ||  1426  |[Counting Elements ](./code/1426.txt) |(E) 900  |
|  1427  |[Perform String Shifts ](./code/1427.txt) |(E) 1000  |
...
|  1548  |[The Most Similar Path in a Graph](./code/1548.txt) |(H) 1800  |
...
|  1618  |[Maximum Font to Fit a Sentence in a Screen ](./code/1618.txt) |(M-) 1400  ||  1628  |[Design an Expression Tree With Evaluate Function ](./code/1628.txt) |(M-) 1400  |
...
#289. [Game of Life (M-) 1400](./code/289.txt) <br />
...
#141. [Linked List Cycle (E) 1000](./code/141.txt) <br />
#143. [Reorder List (M-) 1400](./code/143.txt) <br />
...
#1719. [Number Of Ways To Reconstruct A Tree (H+) 2100](./code/1719.txt) <br />
...
#821. [Shortest Distance to a Character (E) 900](./code/821.txt) <br />
 ...
 ***一个不错新的面试刷题网站***<br/>
 ...
 F. [Graph Without Long Directed Paths(1700)  (二分图解)](./code/550F.txt) <br />
  ...
  ### Codeforces Round #578 (Div. 2)
   ...
   E. [Compress Words (2000) （String + KMP） ](./contest/578E.txt) <br />
 ...
 <br><br><br>
  ...
  791A.[Bear and Big Brother (Implementation) ](./easy/791A.txt) <br />
  ...
  1443B.[Saving the City (dp) ](./easy/1443B.txt) <br />
   ...
   791B.[ Bear and Friendship Condition (UF) ](./easy/791B.txt) <br />
   1105C.[Ayoub and Lost Array (DP + Math) ](./easy/1105C.txt) <br />
  ...
  271D. [Good Substrings (Trie) ](./cf/271D.txt) <br />
  ...
  1286A. [Garland (DP) ](./cf/1286A.txt) <br />
  ...
  1462F. [The Treasure of The Segments (Sort + Binary Search)](./cf/1462F.txt) <br />
   ### 1900<br/>
  ...
  1294F. [Three Paths on a Tree (Tree) ](./cf/1294F.txt) <br />
  ...
  1435D. [Shurikens		(1700) 贪心好题](./code/1435D.txt) <br />
  ...
  <br/>
   ...
   10. [Minumum Cost MaxFlow ](https://github.com/JunBinLiang/CF/blob/main/code/237E.txt) <br />
   <br/>
