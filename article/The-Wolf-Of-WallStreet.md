...
### 问题分析 ：
 ...
 - 假设我们第一次卖发生在 **i**，那么我们第一次交易得发生在 **prices[0 : i]**， 那么我们第二次交易得发生在 **prices[i+1 : n]**
 - 我们可以像第一题的 **题解3** 一样，对于第一次交易，我们枚举每一次**卖**，我们只需要找到 **prices[i+1 : n]** 的一次操作最大利润即可
 - 对于 **prices[i+1 : n]** 这一段，我们可以枚举**买**，如果买发生在**prices[i]**,那么卖得发生在**prices[i+1 : n]**, 是不是跟第一题我们的**题解2**很像？
